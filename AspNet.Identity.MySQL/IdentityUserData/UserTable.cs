...
namespace AspNet.Identity.MySQL.IdentityUserData
{
        ...
        where TUser : IdentityUser
    {
        ...
        {
            var commandText = "Select Name from Users where Id = @id";
        ...
        {
            var commandText = "Select Id from Users where UserName = @name";
        ...
        public List<TUser> GetUserByName(string userName)
        {
            ...
            var commandText = "Select * from Users where UserName = @name";
            var parameters = new Dictionary<string, object> {{"@name", userName}};
        ...
        {
            var commandText = "Select PasswordHash from Users where Id = @id";
        ...
        {
            var commandText = "Update Users set PasswordHash = @pwdHash where Id = @id";
            var parameters = new Dictionary<string, object>();
        ...
        {
            var commandText = "Select SecurityStamp from Users where Id = @id";
            var parameters = new Dictionary<string, object> {{"@id", userId}};
        ...
        {
            var commandText =
                @"Insert into Users (UserName, Id, PasswordHash, SecurityStamp,Email,EmailConfirmed,PhoneNumber,PhoneNumberConfirmed, AccessFailedCount,LockoutEnabled,LockoutEndDateUtc,TwoFactorEnabled)
