...
namespace AspNet.Identity.MySQL.IdentityUserData
{
    ...
    public class UserClaimsTable
    {
        ...
        public ClaimsIdentity FindByUserId(string userId)
        {
            ...
            var commandText = "Select * from UserClaims where UserId = @userId";
            var parameters = new Dictionary<string, object> {{"@UserId", userId}};

            var rows = _database.Query(commandText, parameters);
            foreach (var row in rows)
            {
                var claim = new Claim(row["ClaimType"], row["ClaimValue"]);
        ...
        {
            var commandText = "Delete from UserClaims where UserId = @userId";
        ...
        {
            var commandText = "Insert into UserClaims (ClaimValue, ClaimType, UserId) values (@value, @type, @userId)";
            var parameters = new Dictionary<string, object>();
        ...
        {
            var commandText =
                "Delete from UserClaims where UserId = @userId and @ClaimValue = @value and ClaimType = @type";
            var parameters = new Dictionary<string, object>();
