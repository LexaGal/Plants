 ...
 */
    (function(window, undefined) {
        ...
        var i,
            ...
            pseudos = `:(${characterEncoding})(?:\\(((['"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|${attributes
                .replace(3, 8)})*)|.*)\\)|)`,
            ...
            matchExpr = {
                ...
                "CHILD": new RegExp(`^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(${whitespace
                    }*(even|odd|(([+-]|)(\\d*)n|)${whitespace}*(?:([+-]|)${whitespace}*(\\d+)|))${whitespace
                    }*\\)|)`,
                    "i"),
                "bool": new RegExp(`^(?:${booleans})$`, "i"),
                // For use in libraries implementing .is()
                // We use this for POS matching in `select`
                "needsContext": new RegExp(`^${whitespace}*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(${whitespace
                    }*((?:-\\d)?\\d*)${whitespace}*\\)|)(?=[^-]|$)`,
                    "i")
            },
        ...
        setDocument = Sizzle.setDocument = function(node) {
            ...
            sortOrder = docElem.compareDocumentPosition
                ? function(a, b) {
                    ...
                    const compare = b.compareDocumentPosition &&
...
// Easy API for creating new setFilters
        ...
        function matcherFromGroupMatchers(elementMatchers, setMatchers) {
            ...
            const superMatcher = function(seed, context, xml, results, expandContext) {
                var elem,
                    j,
                    matcher,
                    setMatched = [],
    ...
    jQuery.each(jQuery.expr.match.bool.source.match(/\w+/g),
        function(i, name) {
            ...
            jQuery.expr.attrHandle[name] = getSetInput && getSetAttribute || !ruseDefault.test(name)
                ? function(elem, name, isXML) {
                    const fn = jQuery.expr.attrHandle[name];
                    const ret = isXML
                        ? undefined
                        :
                        /* jshint eqeqeq: false */
            ...
            setup: function() {
                ...
                jQuery.event.add(this,
                    ...
                    function(e) {
                        ...
                        const elem = e.target;
                        const form = jQuery.nodeName(elem, "input") || jQuery.nodeName(elem, "button")
                            ? elem.form
                            : undefined;
                ...
                if (elem || elem === 0) {
                    ...
                    if (jQuery.type(elem) === "object") {
                        ...
                        if (!jQuery.support.tbody) {
                            ...
                            while (j--) {
                                if (jQuery
                                    .nodeName((tbody = elem.childNodes[j]), "tbody") &&
...
// because jsdom on node.js will break without it.
    ...
    function getWidthOrHeight(elem, name, extra) {
        ...
        const isBorderBox = jQuery.support.boxSizing && jQuery.css(elem, "boxSizing", false, styles) === "border-box";
...
// Base "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
    function addToPrefiltersOrTransports(structure) {
        ...
        return function(dataTypeExpression, func) {
            ...
            var dataType,
                i = 0;
            const dataTypes = dataTypeExpression.toLowerCase().match(core_rnotwhite) || [];
    ...
    function Animation(elem, properties, options) {
        ...
        var deferred = jQuery.Deferred()
            ...
            tick = function() {
                ...
                var // archaic crash bug won't allow us to use 1 - ( 0.5 || 0 ) (#12497)
                    index = 0;
...
// Back Compat <1.8 extension point
    ...
    jQuery.offset = {
        setOffset: function(elem, options, i) {
            ...
            const props = {};
            var curPosition = {}, curTop, curLeft;
