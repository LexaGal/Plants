...
(function($) {
    ...
    $.extend($.fn,
    {
        ...
        rules: function(command, argument) {
            ...
            if (command) {
                const settings = $.data(element.form, "validator").settings;
                const staticRules = settings.rules;
    ...
    $.extend($.validator,
    {
        ...
        prototype: {
            init: function() {
                ...
                function delegate(event) {
                    const validator = $.data(this[0].form, "validator");
            ...
            element: function(element) {
                ...
                const result = this.check(element) !== false;
                if (result) {
            ...
            errors: function() {
                const errorClass = this.settings.errorClass.replace(" ", ".");
                ...
                for (let method in rules) {
                    ...
                    try {
                        ...
                        if (this.settings.debug && window.console) {
                            console
                                .log(`Exception occurred when checking element ${element.id}, check the '${rule.method
                                    }' method.`,
                                    e);
                        }
                        throw e;
        ...
        methods: {
            ...
            minlength: function(value, element, param) {
                const length = $.isArray(value) ? value.length : this.getLength($.trim(value), element);
            ...
            equalTo: function(value, element, param) {
                ...
                if (this.settings.onfocusout) {
                    target.unbind(".validate-equalTo")
                        .bind("blur.validate-equalTo",
                            function() {
                                $(element).valid();
                            });
                }
